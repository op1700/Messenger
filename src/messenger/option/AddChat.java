...
public class AddChat extends JFrame {
	...
	ArrayList<String> addfriendList = new ArrayList(); // 추가되는 친구 닉네임을 담는 배열
	...
	public AddChat(MainFrame mainFrame) {
		...
		mainFrame.ct.parserResult.addChat=this;
	...
	public void searchName(String name) {
		...
		if (search == 0) { // 검색을 안한 경우
			...
			lb_info.setFont(new Font(mainFrame.getFontString(), Font.PLAIN, 14));
...
//			chat_name =mainFrame.myProfile[2] + ", " + addfriendList.get(0);
//			
//		}else {
...
//				} else if(i==0) {
//					chat_name += mainFrame.myProfile[2] + ", " + addfriendList.get(i) + ", "; 
//				}else {
//					chat_name += addfriendList.get(i) + ", "; 
//				}
//			}		
//		}
//		for (int i = 0; i < addfriendList.size() + 1; i++) {
//			JSONObject obj = new JSONObject();
//			if (i == 0) {
//				obj.put("Chatmember", mainFrame.myProfile[2]); // 내 닉네임
//			} else {
//				obj.put("Chatmember", addfriendList.get(i - 1)); // 친구 닉네임들
//			}
//			obj.put("ChatName", chat_name); // 채팅방 이름
//			array.add(obj);
//		}
//		System.out.println(array);
//		dispose();
//		new ChatMain(chat_name, mainFrame, array);
//	}
	
	public void send1() { //채팅방이 있나 먼저 확인 해야함
		String chat_name = "";
		if(addfriendList.size()==1) {
			chat_name =mainFrame.myProfile[2] + ", " + addfriendList.get(0);			
		}else {
		...
		for (int i = 0; i < addfriendList.size(); i++) {
			...
			obj.put("FriendNick",addfriendList.get(i));
			
			array.add(obj);
		}
		

		mainFrame.ct.send(array.toJSONString());
