...
public class EmoticonList1 extends JPanel {
   ...
   public EmoticonList1(ChatMain chatMain) {
      ...
      // 아이콘에 이름 붙이기
      la_north1.setName("#icon1_1");
      la_north2.setName("#icon1_2");
      la_north3.setName("#icon1_3");
      la_north4.setName("#icon1_4");
      la_center1.setName("#icon1_5");
      la_center2.setName("#icon1_6");
      la_center3.setName("#icon1_7");
      la_center4.setName("#icon1_8");
      la_south1.setName("#icon1_9");
      la_south2.setName("#icon1_10");
      la_south3.setName("#icon1_11");
      la_south4.setName("#icon1_12");
